---
title: Deployment
description: Deploy the fastest userbot using your preferred method!
---
...
{% callout title="Tip: Select the Nearest server from your location so it won't take long time to connect" %}
{% /callout %}
...
Don't use Special character in your password like @#$% etc.
{% /callout %}
